...
const { decrementThreadCount, getThreadLink } = require("../utils/antiDf");

module.exports = {
  data: new SlashCommandBuilder()
    .setName("sacarantidf")
    .setDescription("Resta 1 al contador de anti-df del hilo vinculado"),
  ...
  async execute(interaction) {
    ...
    const updated = decrementThreadCount(interaction.guild.id, interaction.channel.id, 1);
